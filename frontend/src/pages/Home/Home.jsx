  ...
  return (
    <div className="bgone">
      <section className="md:p-8 xl:p-16 flex justify-center">
        <div className="p-4">
          <h2 className="max-w-[55%] md:max-w-[100%] md:text-xl xl:text-2xl">Trouver tous les services de <strong>MINGLE</strong> immédiatement</h2>
      ...
      <section>
        <div className="p-4 pt-12 xl:flex xl:justify-evenly">
          ...
          <div className="pt-4 xl:max-w-[40%]">
            <h2 className="py-4 font-bold	text-lg">Nos Valeurs :</h2>
            <p>
        ...
        <div className="p-4 xl:pt-20 xl:flex xl:flex-row-reverse xl:justify-evenly">
          ...
          <div className="pt-4 md:max-w-[40%]">
            <h2 className="py-4 font-bold	text-lg">Une plateforme de Partage :</h2>
            <p>
