  ...
  return (
    <div className="container mx-auto p-4 md:p-8 xl:p-12">
      <header className="text-left mb-12">
        ...
        <p className="text-base mb-8 w-full md:w-2/3">
      ...
      <main>
        ...
        <div className="flex flex-col md:flex-row justify-around">
          <div className="text-center p-4 w-full md:w-1/3">
            <img className="mx-auto mb-2 h-80 w-80 object-cover" src={johnDoeImage} alt="John Doe" />
            <p className="font-bold">John Doe</p>
            <p>CEO</p>
            <button className="bg-blue-500 text-white px-4 py-2 mt-2 rounded">View Bio</button>
          </div>
          <div className="text-center p-4 w-full md:w-1/3">
            <img className="mx-auto mb-2 h-80 w-80 object-cover" src={emilyJohnsonImage} alt="Emily Johnson" />
            <p className="font-bold">Emily Johnson</p>
            <p>CTO</p>
            <button className="bg-blue-500 text-white px-4 py-2 mt-2 rounded">View Bio</button>
          </div>
          <div className="text-center p-4 w-full md:w-1/3">
            <img className="mx-auto mb-2 h-80 w-80 object-cover" src={johnSmithImage} alt="John Smith" />
